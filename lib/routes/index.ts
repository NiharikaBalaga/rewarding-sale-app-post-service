...
import { deletePost, postIdPathParam, newPost, validateErrors } from './RequestValidations';
...
function getRouter() {
  ...
  router.get('/:postId', [passport.authenticate('jwt-access', { session: false }), isBlocked, tokenBlacklist, postIdPathParam(), validateErrors, PostServiceController.getPost]);
